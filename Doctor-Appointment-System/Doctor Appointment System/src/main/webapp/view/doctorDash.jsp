...
%>
		...
		<main>
			<div class="head-title">
				<div class="left">
					<h1><%= greeting %> Dr. <%=session.getAttribute("fname")%> <%=session.getAttribute("lname")%></h1>
					<ul class="breadcrumb">
						<li>
							<a href="#">Dashboard</a>
						</li>
			...
			<div class="table-data">
				...
				int id = (int) p_Id; 
				String query="SELECT CONCAT(p_Fname, ' ', p_Lname) AS patient_name, a.app_date, a.app_time FROM appointment a INNER JOIN patient p ON a.p_Id = p.p_Id INNER JOIN doctor d ON a.d_Id = d.d_Id WHERE a.d_Id=" +id;
				try {
		ResultSet rs = db.retrieve(query);
		  ...
		  while (rs.next()) {
		    ...
		    rowData[1] = rs.getString("app_date");
		    rowData[2] = rs.getString("app_time");
